...
Phases included per scheme (Data phase excluded everywhere; for Proposed/DAuth
...
- **Proposed / DAuth** : Device Enrollment + Authentication
...
| **DAuth** | Device Enrollment + Authentication | **0.2943** | **0.0774** |
...
| **DAuth** | enroll 0.237 / 0.062 | — | 0.061 / 0.016 | (in Auth) |
...
- Proposed/DAuth: session key established within Authentication (AS→GW push);
...
DAuth (0.294) carry a heavier device enrollment (2 round-trips to the

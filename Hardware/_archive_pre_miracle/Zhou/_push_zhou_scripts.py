...
print("Pushing updated scripts to Apex (User / measurement target)...")
scp(os.path.join(HERE, "hw_zhou_user.py"),     "192.168.1.132", "apex")
scp(os.path.join(HERE, "..", "common.py"),     "192.168.1.132", "apex")
scp(os.path.join(HERE, "..", "config.py"),     "192.168.1.132", "apex")

print("\nPushing updated scripts to Pi (SN)...")
scp(os.path.join(HERE, "hw_zhou_sn.py"),       "192.168.1.113", "pi")
scp(os.path.join(HERE, "..", "common.py"),     "192.168.1.113", "pi")
scp(os.path.join(HERE, "..", "config.py"),     "192.168.1.113", "pi")

print("\nAll Zhou scripts updated. Ready to run.")

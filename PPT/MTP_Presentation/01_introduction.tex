    ...
    \begin{columns}
        ...
        \begin{column}{0.42\textwidth}
            \begin{block}{Core tension}
                \centering
                \textbf{Strong security} \\ vs. \\ \textbf{Low energy / CPU cost} \\[0.3cm]
...
\begin{frame}{Centralized vs.\ Distributed Authentication}
    ...
    \begin{block}{Plain (parent-centric) distributed schemes}
    ...
    \vspace{0.2cm}
    \begin{alertblock}{DAuth (base scheme, Das \& Khatua, COMSNETS 2026)}

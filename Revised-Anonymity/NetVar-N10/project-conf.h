 ...
 *   Nodes 4–9       = Filler AS motes (inactive, affect RF medium only)
 *   Node  10        = Device node (1 newly joined device; 10% of N=10)
 *
...
#define FIRST_DEVICE_ID  10    /* first device node ID */

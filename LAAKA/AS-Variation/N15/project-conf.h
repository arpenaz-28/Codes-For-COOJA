...
/* --------------------------------------------------------------------------
 * AS-Variation study — N=100 nodes, 15 active Fog AS
 *   Node 1          = GW (RPL root + Registration Authority)
 *   Nodes 2–80      = Fog AS nodes (79 total; only 2–16 active)
 *   Nodes 81–100    = IoT Devices (20 total)
 * -------------------------------------------------------------------------- */
#define GW_NODE_ID       1
#define FOG_BASE_ID      2      /* first active fog node ID */
#define NUM_ACTIVE_FOG   15      /* active fog count for this variant */

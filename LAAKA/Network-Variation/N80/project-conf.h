 ...
 *   Nodes 4–72      = Filler Fog motes (inactive, affect RF medium only)
 *   Nodes 73–80     = IoT Devices (8 newly joined)
 *
 *   Devices 73–76   → FOG1 (node_id < FOG_SPLIT_ID)
 *   Devices 77–80   → FOG2 (node_id >= FOG_SPLIT_ID)
 * -------------------------------------------------------------------------- */
#define GW_NODE_ID       1
#define FOG1_NODE_ID     2
#define FOG2_NODE_ID     3
#define FOG_SPLIT_ID     77    /* devices [73,76] → FOG1, [77,80] → FOG2 */

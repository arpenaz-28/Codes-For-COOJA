 ...
 *   Nodes 4–9       = Filler Fog motes (inactive, affect RF medium only)
 *   Node  10        = IoT Device (1 newly joined; 10% of N=10)
 *
 *   Device 10 → FOG1 (node_id < FOG_SPLIT_ID=11)
 * -------------------------------------------------------------------------- */
#define GW_NODE_ID       1
#define FOG1_NODE_ID     2
#define FOG2_NODE_ID     3
#define FOG_SPLIT_ID     11    /* devices [10,10] → FOG1; none → FOG2 */

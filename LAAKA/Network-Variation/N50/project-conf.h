 ...
 *   Nodes 4–45      = Filler Fog motes (inactive, affect RF medium only)
 *   Nodes 46–50     = IoT Devices (5 newly joined)
 *
 *   Devices 46–47   → FOG1 (node_id < FOG_SPLIT_ID)
 *   Devices 48–50   → FOG2 (node_id >= FOG_SPLIT_ID)
 * -------------------------------------------------------------------------- */
#define GW_NODE_ID       1
#define FOG1_NODE_ID     2
#define FOG2_NODE_ID     3
#define FOG_SPLIT_ID     48    /* devices [46,47] → FOG1, [48,50] → FOG2 */

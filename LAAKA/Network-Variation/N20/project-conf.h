 ...
 *   Nodes 4–18      = Filler Fog motes (inactive, affect RF medium only)
 *   Nodes 19–20     = IoT Devices (2 newly joined)
 *
 *   Device 19  → FOG1 (node_id < FOG_SPLIT_ID)
 *   Device 20  → FOG2 (node_id >= FOG_SPLIT_ID)
 * -------------------------------------------------------------------------- */
#define GW_NODE_ID       1
#define FOG1_NODE_ID     2
#define FOG2_NODE_ID     3
#define FOG_SPLIT_ID     20    /* devices [19,19] → FOG1, [20,20] → FOG2 */

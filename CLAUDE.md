...
- The **hardware** evaluation chart (`fig_hw_comparison.png`) still plots **Proposed, LAAKA, Zhou** only (verified from `Hardware/plot_hw_comparison.py`); DAuth is not yet in the hardware comparison.

...
\textbf{LAAKA}~\cite{ali2024laaka} employs ECC to protect device identity during
mutual authentication; ECC operations, however, incur higher power consumption than
may be tolerable on severely constrained nodes.
...
a dual-state recovery mechanism at both the authentication server and the gateway.
